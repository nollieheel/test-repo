...
def get_args():
  ...
  """
  parser = argparse.ArgumentParser(description='perform rolling termination ' +
    'deploy on a given AWS autoscaling group')

  parser.add_argument('asg_name', help='name of autoscaling group')
